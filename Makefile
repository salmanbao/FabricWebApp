...
generated-artifacts/crypto-config: source-artifacts/crypto-config.yaml
	...
	mkdir -p generated-artifacts/crypto-config/peerOrganizations/org2.example.com/msp/intermediatecerts
	mkdir -p generated-artifacts/crypto-config/peerOrganizations/org2.example.com/msp/crls
